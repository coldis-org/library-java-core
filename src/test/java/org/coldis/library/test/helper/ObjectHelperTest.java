...
public class ObjectHelperTest {
	...
	public void testDeepCopyAttributesIgnoring() {
		...
		final TestClass target = new TestClass("target", 2L, new TestClass(), new TestClass(), null, Map.of());
		// Shallow copy the attributes.
	...
	public void testDeepCopyAttributesUsingConditions() {
		// Test data.
		final TestClass source = new TestClass("source", 1L, new TestClass("source1", 11L, null, null, null, Map.of("test1", 1, "test2", 2, "test3", "")),
				new TestClass("source1", 12L, null, null, null, Map.of("2", 2)), BigDecimal.ONE, Map.of());
		...
		Assertions.assertEquals(new TestClass("source1", 11L, null, null, null, Map.of("test1", 1)), target.getTest3());
