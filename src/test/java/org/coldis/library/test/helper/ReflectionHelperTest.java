...
public class ReflectionHelperTest {
	...
	private static final List<TestClass> TEST_DATA = List.of(
			new TestClass("1", 1l, new TestClass("1", 1L, new TestClass("1", 1L, null, null), null),
					new TestClass("1", 1L, null, null)),
			new TestClass("2", 2l, new TestClass("2", 2L, new TestClass("2", 2L, null, null), null),
					new TestClass("2", 2L, null, null)));
